...
The logistic regression model was deployed into Heroku. The link to the application is available under 'Environment' section on right side of the repository.
